...
async function getTaskWithProject(
    ...
    return Task.findOne({
        ...
        path: 'projectId',
        select:
            'owner members title archived deleted workspaceId'
    });
}

function employeeCanAccessTask(
    task,
    userId
) {
...
router.get(
    ...
    async (req, res) => {
        ...
        try {
            ...
            res.status(500).json({
                message:
                    'Server error loading archived tasks.'
            });
        }
    }
);
    ...
    async (req, res) => {
        ...
        try {
            ...
            if (project.archived) {
                return res.status(400).json({
                    message:
                        'You cannot add tasks to an archived project.'
                });
            }
